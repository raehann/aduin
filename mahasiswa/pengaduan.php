<table id="example" class="display responsive-table" style="width:100%">
	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN mahasiswa ON pengaduan.nim=mahasiswa.nim WHERE pengaduan.nim='".$_SESSION['data']['nim']."' AND status='proses' ORDER BY pengaduan.id_pengaduan DESC");
