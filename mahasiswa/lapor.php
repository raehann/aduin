<?php 
    ...
    include('../conn/koneksi.php');
        ...
        $tgl = date('Y-m-d');
		$no=1;
		$pengaduan = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN mahasiswa ON pengaduan.nim=mahasiswa.nim");
		 { ?>
    ...
    <section class="container3">
        <form method="POST" enctype="multipart/form-data">
          <div class="input-box" style="color: #fff;">
            ...
            <br><?php echo ucwords($_SESSION['data']['nim']); ?>
          </div>
		...
		if($foto !=""){
		 	if(in_array($eks, $listeks)){
		 		if($size<=100000){
					...
					$query = mysqli_query($koneksi,"INSERT INTO pengaduan VALUES (NULL,'$tgl','$nim','".$_POST['judul']."','".$_POST['laporan']."','$nama','proses')");
			...
			$query = mysqli_query($koneksi,"INSERT INTO pengaduan VALUES (NULL,'$tgl','$nim','".$_POST['judul']."','".$_POST['laporan']."','noImage.png','proses')");
			if($query){
