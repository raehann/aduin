...
<head>
  ...
  <title>ADUIN - Situs Pengaduan Mahasiswa</title>
    ...
    <div class="container">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="home-greets">
          <h1 class="dark-mode-text my-1 block text-4xl font-bold text-dark lg:text-[40px]"> AD<span style="color: #4CB9E7;" >UIN</span></h1>
          <h3 class="dark-mode-text mb-5 text-base font-semibold text-secondary md:text-lg">Situs Pengaduan Mahasiswa UIN Jakarta
          </h3>
          <p class="dark-mode-text mb-10 text-base leading-relaxed text-secondary md:text-base">
            <span class="font-bold md:text-xl">"</span>Tunjukkan suaramu di ADUIN! Bersama, kita wujudkan perubahan positif untuk UIN Jakarta.<span
  ...
  <section id="about" class="dark-mode py-24">
    <div class="container">
      <div class="title-main">
        <h2 class="text-title">PENGADUAN MAHASISWA</h2>
	<br>
        <span class="text-subtitle block mb-6 text-base font-semibold text-secondary md:text-lg">Selamat datang di situs ADUIN, Situs pengaduan mahasiswa UIN Jakarta untuk kritik, saran, dan aspirasi online. Memudahkan mahasiswa menyampaikan masalah dan ide mereka kepada pihak kampus dengan aman dan terstruktur. Mendorong transparansi dan solusi bagi pengalaman kampus yang lebih baik.</span>
      </div>
    </div>
  </section>
            ...
            <div class="flex flex-wrap px-2 pb-5">
              <div class="w-5/2">
                ...
                <div class="skill-list">
                  ...
                  <span class="skill-list-name">3. Pengaduan akan didisposisi ke petugas terkait</span>
                </div>
                <div class="skill-list">
                  <i class="text-3xl text-[#06B6D4]"></i>
                  <span class="skill-list-name">4. Pengaduan akan ditindaklanjuti oleh petugas dan menjawab pengaduan mahasiswa</span>
                </div>
              </div>
            </div>
          </div>
  ...
  <section id="contact" class="dark-mode pt-24 pb-28">
    <div class="container">
      <div class="title-main">
        ...
        <span class="text-subtitle block">UIN Jakarta</span>
      </div>
      <div class="contact-data">
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="https://maps.app.goo.gl/7ExrK9YV2x7hNkmcA" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/location.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">Jl. Ir H. Juanda No.95, Ciputat, Kota Tangerang Selatan, Banten 15412</span>
            </div>
          </a>
        </div>
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="mailto:humas@uinjkt.ac.id" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/email.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">uinjkt@ac.id</span>
            </div>
          </a>
        </div>
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="https://uinjkt.ac.id" target="_blank" class="contact-icons">
        ...
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="#" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/phone.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">(021) 7401925</span>
            </div>
          </a>
        </div>
      </div>
  ...
  <footer class="bg-primary pt-16 pb-12">
    <div class="container">
      ...
      <div class="w-full border-t border-slate-400 pt-10">
        <span class="ml-4 text-sm text-icons">&#169; 2023 <span class="font-semibold">RPL - Kelompok 3</span>. All Rights
          Reserved</span>
      </div>
